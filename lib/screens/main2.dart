...
import 'package:frontmain/screens/add.dart';
...
import 'package:frontmain/screens/diabetes_medicine.dart';
import 'package:frontmain/screens/edit.dart'; // Import หน้าแก้ไขใหม่
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const Editpage(), // เพิ่ม const ตรงนี้
                          ),
                        );
                      },
