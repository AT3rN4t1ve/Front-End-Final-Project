...
class Listnoti2Page extends StatefulWidget {
  const Listnoti2Page({super.key});

  @override
  State<Listnoti2Page> createState() => _Listnoti2PageState();
}

class _Listnoti2PageState extends State<Listnoti2Page> {
